...
-(void)addRightButton
{
    ...
    self.rightButton.frame = CGRectMake(size.width - RIGHT_BUTTON_SIZE,
                                        0,
                                        RIGHT_BUTTON_SIZE,
                                        40);
    ...
    //self.rightButton.frame = CGRectMake(/*size.width - RIGHT_BUTTON_SIZE*/ 310, /*0*/ 5, RIGHT_BUTTON_SIZE, /*size.height*/ 50);
